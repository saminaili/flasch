...
/**
 * Servlet implementation class GitSuchen
 */
@WebServlet("/GitSuchen")
public class GitSuchen extends HttpServlet {
	...
	String gitid=request.getParameter("gitt");
		int git=Integer.parseInt(gitid);
		...
		List<Membre>list=MembreSQL.getGit(git);
