...
/**
 * Servlet implementation class ScalaSuchen
 */
@WebServlet("/ScalaSuchen")
public class ScalaSuchen extends HttpServlet {
	...
	String scalaid=request.getParameter("sca");
		int scala=Integer.parseInt(scalaid);
		...
		List<Membre>list=MembreSQL.getScala(scala);
