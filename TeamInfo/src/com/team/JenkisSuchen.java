...
/**
 * Servlet implementation class JenkisSuchen
 */
@WebServlet("/JenkisSuchen")
public class JenkisSuchen extends HttpServlet {
	...
	String jenkisid=request.getParameter("jen");
		int jenkis=Integer.parseInt(jenkisid);
		...
		List<Membre>list=MembreSQL.getJenkis(jenkis);
